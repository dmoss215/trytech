...
INSERT INTO products (product_name, manufacturer, product_description, retail_price, image_url, rating, units_available) 
VALUES
...
299.00,
"assets/images/bose-soundware-companion.jpeg",
8.4,
4
-- NOW(),
-- NOW()
...
INSERT INTO users (user_firstname, user_lastname, user_email, address_street, address_city, address_state, address_zip, payment_method, agreement_signed, subscription_type, date_registered) 
VALUES
...
INSERT INTO subscriptions (tier_name, monthly_cost, num_devices, num_days)
VALUES
